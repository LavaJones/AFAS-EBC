...
{
    public interface IV1094InitialPart3Service : ICrudDomainService<V1094InitialPart3>
    {
        /// <summary>
        ...
        IQueryable<V1094InitialPart3> FilterForEmployerId(int EmployerId, int TaxYear);
