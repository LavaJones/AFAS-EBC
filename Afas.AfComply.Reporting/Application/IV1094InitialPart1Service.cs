...
{
    public interface IV1094InitialPart1Service : ICrudDomainService<V1094InitialPart1>
    {
        /// <summary>
        ...
        IQueryable<V1094InitialPart1> FilterForEmployerIdAndTaxYear(int EmployerId, int TaxYear);
