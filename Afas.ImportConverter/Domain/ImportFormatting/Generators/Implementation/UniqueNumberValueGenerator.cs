...
namespace Afas.ImportConverter.Domain.ImportFormatting.Generators.Implementation
{
    ...
    /// </summary>
    public class UniqueNumberValueGenerator : IValueGenerator
    {
        ...
        public String GenerateValue(string pattern)
        {
            ...
            return Regex.Replace(pattern, Regex.Escape(GetPlaceholder), (match) => DateTime.Now.Ticks.ToString());
        ...
        /// </summary>
        public String GetPlaceholder { get { return "[UNIQUE]"; } }
