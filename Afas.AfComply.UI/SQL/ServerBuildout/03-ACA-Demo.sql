...
-- end of ACA-Demo-Intial.sql

-- start of ACA-Demo-Migration-001_to_002.sql
USE [aca-demo]
GO
...
-- end of ACA-Demo-Migration-001_to_002.sql

-- start of ACA-Demo-Migration-002_to_003.sql
...
-- end of ACA-Demo-Migration-002_to_003.sql

-- start of ACA-Demo-Migration-003_to_004.sql
...
-- end of ACA-Demo-Migration-003_to_004.sql

-- start of ACA-Demo-Migration-004_to_005.sql
...
-- end of ACA-Demo-Migration-004_to_005.sql

-- start of ACA-Demo-Migration-005_to_006.sql
...
-- end of ACA-Demo-Migration-005_to_006.sql

-- start of ACA-Demo-Migration-006_to_007.sql
...
-- end of ACA-Demo-Migration-006_to_007.sql

-- start of ACA-Demo-Migration-007_to_008.sql
...
-- end of ACA-Demo-Migration-007_to_008.sql

-- start of ACA-Demo-Migration-008_to_009.sql
...
-- end of ACA-Demo-Migration-008_to_009.sql

-- start of ACA-Demo-Migration-009_to_010.sql
...
-- end of ACA-Demo-Migration-009_to_010.sql

-- start of ACA-Demo-Migration-010_to_011.sql
...
SET NOCOUNT ON;
    ...
    UPDATE [aca-demo].[dbo].[user] SET floater = @setFloater
...
DELETE  [aca-demo].dbo.employee_insurance_offer
  where employer_id=@employerID
...
-- end of ACA-Demo-Migration-010_to_011.sql

-- start of ACA-Demo-Migration-011_to_012.sql
...
AS
BEGIN TRY
delete FROM [aca-demo].[dbo].[employee_dependents] where employee_id in (select employee_id FROM [aca-demo].[dbo].[employee] where employer_id = @employerID);

delete FROM [aca-demo].[dbo].[insurance_coverage] where employee_id in (select employee_id FROM [aca-demo].[dbo].[employee] where employer_id = @employerID);

delete FROM [aca-demo].[dbo].[import_insurance_coverage] where [employer_id] = @employerID;

delete FROM [aca-demo].[dbo].[import_payroll] where employerid = @employerID;

delete FROM [aca-demo].[dbo].[payroll] where employer_id = @employerID;

delete FROM [aca-demo].[dbo].[employee_insurance_offer] where employer_id = @employerID;

delete FROM [aca-demo].[dbo].[employee] where employer_id = @employerID;

delete FROM [aca-demo].[dbo].[import_employee] where employerID = @employerID;

DELETE FROM [aca-demo].[dbo].[hr_status] where employer_id = @employerID;

DELETE FROM [aca-demo].[dbo].[gross_pay_type] where employer_id = @employerID;
...
-- end of ACA-Demo-Migration-011_to_012.sql

-- start of ACA-Demo-Migration-012_to_013.sql
...
BEGIN TRY
    ...
    UPDATE [aca-demo].[dbo].[employee_type] SET name = @name
      WHERE employer_id = @employerId
...
BEGIN TRY
    ...
    INSERT INTO [aca-demo].[dbo].[employee_type] (name,employer_id)
...
BEGIN TRY
    ...
    DELETE [aca-demo].[dbo].[employee_type]
...
GRANT EXECUTE ON [dbo].[SELECT_BreakInService] TO [aca-user] AS [dbo]
GO
-- end of ACA-Demo-Migration-012_to_013.sql

-- start of ACA-Demo-Migration-013_to_014.sql
...
-- end of ACA-Demo-Migration-013_to_014.sql

-- start of ACA-Demo-Migration-014_to_015.sql
...
alter Table [aca-demo].[dbo].[plan_year] add 
...
-- end of ACA-Demo-Migration-014_to_015.sql

-- start of ACA-Demo-Migration-015_to_016.sql
...
-- end of ACA-Demo-Migration-015_to_016.sql

-- end of ACA-Demo-Migration-016_to_017.sql
...
-- start of ACA-Demo-Migration-017_to_018.sql
...
-- end of ACA-Demo-Migration-017_to_018.sql

-- start of ACA-Demo-Migration-018_to_019.sql
...
-- end of ACA-Demo-Migration-018_to_019.sql
--Start Migration script 19-20
