...
GRANT EXECUTE ON [dbo].[spUpdateAIR-InsertMissingEmployee] TO [air-user] AS [dbo] 
GO
...
BEGIN TRY
	BEGIN TRAN ETL_BUILD
		BEGIN
			...
			EXECUTE [air].[appr].[spUpdate_1095C_status_for_employee] @employer_id, @year_id, @employee_id
