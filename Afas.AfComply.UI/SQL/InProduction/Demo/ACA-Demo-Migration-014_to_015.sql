...
Drop TABLE [dbo].[ArchiveFileInfo];
GO
-----------------------------------------------------
Drop PROCEDURE [dbo].[SELECT_ArchiveFileInfo];
GO
Drop PROCEDURE [dbo].[SELECT_ArchiveFileInfo_ForEmployer];
GO
Drop PROCEDURE [dbo].[INSERT_ArchiveFileInfo];
GO
