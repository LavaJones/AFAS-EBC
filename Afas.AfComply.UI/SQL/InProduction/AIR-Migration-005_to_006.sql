	...
	(
		time_frame_id <= 
			IIF(
						...
						air.etl.ufnGetTimeFrameID(YEAR(ISNULL(terminationDate,'2016-01-01')), MONTH(ISNULL(terminationDate,'2016-12-31'))), 
						-- reducing confusion by setting dates for 2016 reporting, 2015 measurement. gc5
						air.etl.ufnGetTimeFrameID(YEAR('2016-12-01'), 12)) -- not sure why this is not 12-31. gc5
				)
				AND
		-- reducing confusion by setting dates for 2016 reporting, 2015 measurement. gc5
		(time_frame_id BETWEEN (air.etl.ufnGetTimeFrameID(YEAR('2016-01-01'), 1)) AND air.etl.ufnGetTimeFrameID(YEAR('2016-12-31'), 12))
		AND
