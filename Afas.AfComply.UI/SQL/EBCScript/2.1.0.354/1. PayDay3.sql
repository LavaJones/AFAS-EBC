...
/****** Object:  View [dbo].[View_1094Part3]    Script Date: 3/13/2018 3:52:42 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT 
       ...
       Receiving1095C,
       TaxYear, 
	   cast(OfferedInsurance as bit) as OfferedInsurance, 
       MonthId  
from
(
       select distinct
			...
			End AS Receiving1095C, 
                      p2.TaxYear,
                      CASE
						WHEN p2.Line14 = '1A' OR all12.Line14 = '1A' THEN 1 
                        WHEN p2.Line14 = '1C' OR all12.Line14 = '1C' THEN 1
                        WHEN p2.Line14 = '1E' OR all12.Line14 = '1E' THEN 1
                        WHEN p2.Line14 = '1F' OR all12.Line14 = '1F' THEN 1
						WHEN p2.Line14 = '1K' OR all12.Line14 = '1K' THEN 1 
						WHEN p2.Line14 = '1B' OR all12.Line14 = '1B' THEN 0
						WHEN p2.Line14 = '1D' OR all12.Line14 = '1D' THEN 0
                        WHEN (p2.Line14 = '1H' and p2.line16 = '2E') OR (all12.Line14 = '1H' and all12.line16 = '2E') THEN 1
