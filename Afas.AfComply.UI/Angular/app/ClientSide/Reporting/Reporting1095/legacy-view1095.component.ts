...
@Component({
    ...
    selector: 'view-1095',
    templateUrl: './legacy-view1095.component.html',
    styleUrls: ['./legacy-view1095.component.css'
    ],
...
export class LegacyView1095sComponent implements OnInit {
    encryptedId: string;
    title = 'Employer 1095';
    ...
    refreshList(encryptedValue: string): void {
        ...
        this.employee1095summaryService.getSome(encryptedValue).then(all => {
    ...
    Finalize1095(): void {
        ...
        this.employee1095summaryService.finalize1095(this.employees[0]).then(all => {
            this.refreshList(this.selectedTaxYear);
    ...
    saveFiles(files) {
        ...
        this.employee1095summaryService.uploadEditFile(files[0], this.selectedTaxYear).then(all => {
