...
{
    public class Transmission1094ViewModel : BaseViewModel
    {

        public Transmission1094ViewModel() : base() { }
        ...
        /// </summary>
        [Required]
        public virtual IList<Transmission1095ViewModel> All1095Tranmissions { get; set; }
