<%@ Page EnableSessionState="ReadOnly" Language="C#" AutoEventWireup="true" CodeBehind="import_insurance_change_event.aspx.cs" Inherits="import_insurance_change_event" %>
...
<html>
<head>
    <title>Import Insurance Change Events</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="container">
            ...
            <div id="topbox">
                <div id="tbleft">
                    <h4>Insurance Offer Change Events Import</h4>
                    ...
                    <br />
                    <br />
                    <label class="lbl3">Select Insurance Offer Change Event File</label>
