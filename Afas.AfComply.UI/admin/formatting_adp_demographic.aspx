<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formatting_adp_demographic.aspx.cs" Inherits="admin_adp_formatting_payroll" %>
...
<html>
<head>
    <title>Format ADP Demographic Files</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="container">
            ...
            <div id="topbox">
                <div id="tbleft">
                    <h4>ADP Demographic - File Conversion</h4>
                    <ul>
                ...
                <div id="tbright">
                    <h4>Upload ADP .CSV Demogrpahic File</h4>
                    <p>
                        * The naming convention must be as follows:
                   
                        <br />
                        ADP_DEM_0999_CurrentDate.txt
