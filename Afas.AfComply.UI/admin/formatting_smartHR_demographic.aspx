<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formatting_smartHR_demographic.aspx.cs" Inherits="admin_smartHR_formatting_demographic" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="container">
            ...
            <div id="topbox">
                <div id="tbleft">
                    <h4>Smart HR Demographic- File Conversion</h4>
                    <ul>
                    ...
                    <br />
                    <br />
                    <label class="lbl3">Select Dem File</label>
                ...
                <div id="tbright">
                    <h4>Upload SHR .CSV Demographic File</h4>
                    <p>
                        * The naming convention must be as follows:
                   
                        <br />
                        SHR_DEM_0999_CurrentDate.txt
                    ...
                    <span>
                        <ul>
                            <li>The Demographic File must be a .dat text file</li>
                        </ul>
                    </span>
                    <br />
                    <br />
