<%@ Page EnableSessionState="ReadOnly" Language="C#" AutoEventWireup="true" CodeBehind="import_insurance_carrier.aspx.cs" Inherits="admin_ins_import" %>
...
<html>
<head>
    <title>Import Insurance Carrier</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="container">
            ...
            <div id="topbox">
                <div id="tbleft">
                    <h4>Yearly Insurance Carrier Import</h4>
                    ...
                    <br />
                    <br />
                    <label class="lbl3">Select Carrier</label>
                    <asp:DropDownList ID="DdlCarrier" runat="server" CssClass="ddl2"></asp:DropDownList>
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    <label class="lbl3">Select Insurance Carrier File</label>
                    <asp:DropDownList ID="DdlFileList" runat="server" CssClass="ddl2"></asp:DropDownList>
                    <br />
                    <br />
                    <asp:Button ID="BtnProcessFileAndTransfer" runat="server" Text="Submit and Transfer" CssClass="btn" OnClick="BtnProcessFileAndTransfer_Click" />
                    <br />
                    <br />
                    <asp:Button ID="BtnProcessFile" runat="server" Text="Submit" CssClass="btn" OnClick="BtnProcessFile_Click" />
                    <br />
                    <asp:Button ID="BtnValidateEmployees" runat="server" Text="Validate Employees" CssClass="btn" OnClick="BtnValidateEmployees_Click" />
                    <br />
                    <asp:Button ID="BtnValidateDependents" runat="server" Text="Validate Dependents" CssClass="btn" OnClick="BtnValidateDependents_Click" />
                    <br />
                    <asp:Button ID="BtnInvalidEmployees" runat="server" Text="Generate Employee Alerts" CssClass="btn" OnClick="BtnInvalidEmployees_Click" />
                    <br />
                    <asp:Button ID="BtnTransferRecords" runat="server" Text="Transfer Records" CssClass="btn" OnClick="BtnTransferRecords_Click" />
                    <br />
                </div>
                <div id="tbright">
                    ...
                    <span>
                        <ul>
                            <li>The Insurance Carrier File must be a "comma delimited" .csv file.</li>
