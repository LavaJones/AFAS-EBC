<%@ Page EnableSessionState="ReadOnly" Language="C#" AutoEventWireup="true" CodeBehind="import_payroll.aspx.cs" Inherits="admin_payroll_import" %>
        ...
        <div id="container">
            ...
            <div id="topbox">
                <div id="tbleft">
                    ...
                    <br />
                    <br />
                    <asp:Button ID="BtnReScanData" runat="server" Text="Re-Scan Payroll Alerts" CssClass="btn" OnClick="BtnReScanData_Click" />
                </div>
                <div id="tbright">
                    <h4>Upload File</h4>
