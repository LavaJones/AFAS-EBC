<%@ Page EnableSessionState="ReadOnly" Language="C#" AutoEventWireup="true" CodeBehind="import_offer.aspx.cs" Inherits="admin_import_offer" %>
        ...
        <div id="container">
            ...
            <div id="topbox">
                <div id="tbleft">
                    ...
                    <span>
                        <ul>
                            <li>The Offer must be a .dat text file</li>
