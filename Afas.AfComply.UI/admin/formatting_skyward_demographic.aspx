<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formatting_skyward_demographic.aspx.cs" Inherits="admin_skyward_formatting" %>
...
<html>
<head>
    <title>Format Skyward Demographic Files</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="container">
            ...
            <div id="topbox">
                <div id="tbleft">
                    <h4>Skyward Demographic - File Conversion</h4>
                    <ul>
                        <li>Step 1: Select an EMPLOYER. </li>
                        <li>Step 2: Select a DEMOGRAPHIC FILE to import.</li>
                ...
                <div id="tbright">
                    <h4>Upload Skyward .CSV Demographic file</h4>
                    <p>
                        *Currently each School District must export their own file from their Skyward software and import it into the software. If they have not done this, you can get the file from them and import using this form. 
                    ...
                    <p>
                        * The naming convention must be as follows:
                        ...
                        <br />
                        SKYWARD_DEM_0999_CurrentDate.txt
            ...
            <asp:GridView ID="GvCurrentFiles" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="1024px" AutoGenerateColumns="false" OnRowDeleting="GvCurrentFiles_RowDeleting" EmptyDataText="This EMPLOYER currently has no files to format." OnRowUpdating="GvCurrentFiles_RowUpdating">
