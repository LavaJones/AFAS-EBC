<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_float_user.aspx.cs" Inherits="admin_admin_float_user" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="container">
            <div id="header">
                ...
                <ul id="toplinks">
                    <li>Need Help? Call <%= System.Configuration.ConfigurationManager.AppSettings["Branding.Phonber"] %></li>
                    <li>
            ...
            <div id="topbox">
                <div id="tbleft">
                    <h4>Administrative - Move User</h4>
                    <label class="lbl3">Employer</label>
                    <asp:DropDownList ID="DdlEmployer" runat="server" CssClass="ddl2"></asp:DropDownList>
                    <br />
                    <br />
                    <label class="lbl3">User</label>
                    <asp:DropDownList ID="DdlUser" runat="server" CssClass="ddl2"></asp:DropDownList>
                    <br />
                    <br />
                ...
                <div id="tbright">
                    ...
                    <dl>
                        <dt>Step 1:</dt>
                        <dd>- Select the EMPLOYER that would like the USER to move too.</dd>
                        <dt>Step 2:</dt>
                        <dd>- Select the USER that you will be moving.</dd>
                        <dt>Step 3:</dt>
        ...
        <asp:Panel ID="PnlRollover" runat="server">
            ...
            <div style="position: relative; margin-left: auto; padding: 5px; margin-right: auto; border-radius: 10px; width: 600px; height: auto; margin-top: 0px; font-size: 12px; background-color: white; z-index: 10">
                ...
                <h3 style="color: black;">User has been moved</h3>
