<%@ Page EnableSessionState="ReadOnly" Language="C#" AutoEventWireup="true" CodeBehind="import_employee_class.aspx.cs" Inherits="admin_employee_class_import" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="container">
            ...
            <div id="topbox">
                ...
                <div id="tbright">
                    <h4>Upload File</h4>
                    <asp:FileUpload ID="FuEmployeeClassFile" runat="server" Width="350px" />
                    <br />
                    <br />
                    <span>
                        <ul>
