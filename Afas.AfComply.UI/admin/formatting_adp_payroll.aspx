<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formatting_adp_payroll.aspx.cs" Inherits="admin_adp_payroll" %>
...
<html>
<head>
    <title>Format ADP Payroll Files</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="container">
            ...
            <div id="topbox">
                <div id="tbleft">
                    <h4>ADP Payroll - File Conversion</h4>
                    <ul>
                ...
                <div id="tbright">
                    <h4>Upload ADP .CSV Payroll File</h4>
                    <p>
                        * The naming convention must be as follows:
                   
                        <br />
                        ADP_PAY_0999_CurrentDate.txt
