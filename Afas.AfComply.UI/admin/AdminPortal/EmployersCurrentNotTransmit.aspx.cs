...
{
    public partial class EmployersCurrentNotTransmit : Afas.AfComply.UI.admin.AdminPageBase
    {
        ...
        {
            GridEmployerTransmitCount.DataSource = employerController.GetNotTransmittedCountPerEmployer(TaxYearId);
            GridEmployerTransmitCount.DataBind();
        }
    }
}