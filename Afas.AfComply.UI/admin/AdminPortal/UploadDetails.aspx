<%@ Page EnableSessionState="ReadOnly" Title="UploadManager" Language="C#" MasterPageFile="AdminPortal.Master" AutoEventWireup="true"
    CodeBehind="UploadDetails.aspx.cs" Inherits="Afas.AfComply.UI.admin.AdminPortal.UploadDetails" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" PopupControlID="PnlReUpload" TargetControlID="HfDummyTrigger"></asp:ModalPopupExtender>

    <asp:Panel ID="Panel1" runat="server" DefaultButton="BtnUploadFile">
        <div style="position: fixed; top: 0; left: 0; background-color: black; opacity: 0.8; width: 100%; height: 100%; ">
        </div>
        <div style="position: relative; margin-left: auto; padding: 50px; margin-right: auto; border-radius: 10px; width: 800px; height: auto; margin-top: 0px; font-size: 12px; background-color: white;">
            <div style="position: absolute; width: 30px; height: 30px; opacity: 1.0; line-height: 20px; right: -10px; top: -10px; text-align: center;">
            ...
            <asp:Button ID="BtnUploadProcessedFile" runat="server" CssClass="btn" Text="Submit" OnClick="BtnUploadProcessedFile_Click" />
            <asp:ConfirmButtonExtender ID="ConfirmButtonExtender1" runat="server" TargetControlID="BtnUploadProcessedFile" ConfirmText="Are you sure that you want to replace the original File with this one?"></asp:ConfirmButtonExtender>
        </div>
    ...
    <h3>
        <asp:Literal ID="Lit_gv_Up_name" runat="server"></asp:Literal>
    </h3>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Re-Upload" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:ImageButton ID="reUpload" runat="server" Height="30px" ImageUrl="~/design/Upload.png"
                            Width="30px" BorderStyle="None" AlternateText="Re-Upload File"
                            CommandName="ReuploadFile" CommandArgument='<%# Eval("StagingImportId") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
