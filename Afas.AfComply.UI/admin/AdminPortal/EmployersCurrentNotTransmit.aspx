<%@ Page EnableSessionState="ReadOnly" Title="Current Non-Transmitted for All Employers" Language="C#"
    MasterPageFile="AdminPortal.Master" AutoEventWireup="true" CodeBehind="EmployersCurrentNotTransmit.aspx.cs" 
    Inherits="Afas.AfComply.UI.admin.AdminPortal.EmployersCurrentNotTransmit" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <h2>Current Non-Transmitted for All Employers"</h2>
    <br />
    ...
    <asp:GridView ID="GridEmployerTransmitCount" runat="server" AutoGenerateColumns="false"
        HeaderStyle-Height="30" RowStyle-Height="30" CellPadding="5" PageSize="100">
        <Columns>
            <asp:TemplateField HeaderText="Employer Name" HeaderStyle-Width="25%" SortExpression="EmployerName" HeaderStyle-HorizontalAlign="Left">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Employees Not Transmitted Count" HeaderStyle-Width="25%" SortExpression="TransmitCount" HeaderStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    <asp:Literal ID="LitTransmittCount" runat="server" Text='<%# Eval("TransmitCount") %>'></asp:Literal>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
