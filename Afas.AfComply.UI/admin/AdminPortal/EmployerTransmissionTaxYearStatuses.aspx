<%@ Page EnableSessionState="ReadOnly" Title="Detailed Information About An Employer's Transmission Status" Language="C#" 
    MasterPageFile="AdminPortal.Master" AutoEventWireup="true" CodeBehind="EmployerTransmissionTaxYearStatuses.aspx.cs" 
    Inherits="Afas.AfComply.UI.admin.AdminPortal.EmployerTransmissionTaxYearStatuses" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <h2>Detailed Information About An Employer's Transmission Status</h2>
    <br />
    ...
    <asp:GridView ID="gEmployerTransmissionStatuses" runat="server" AutoGenerateColumns="false"
        HeaderStyle-Height="30" RowStyle-Height="30" CellPadding="5">
        <Columns>
            <asp:TemplateField HeaderText="Transmission Status" HeaderStyle-Width="50%" SortExpression="TransmissionStatusId" HeaderStyle-HorizontalAlign="Left">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="End Date" HeaderStyle-Width="25%" SortExpression="EndDate" HeaderStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    <asp:Label ID="LitEndDate" runat="server" Text='<%# Eval("EndDate") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
