<%@ Page EnableSessionState="ReadOnly" Title="Current Unprinted PDFs for All Employers" Language="C#" 
    MasterPageFile="AdminPortal.Master" AutoEventWireup="true" CodeBehind="EmployersCurrentNotPrintedPdf.aspx.cs" 
    Inherits="Afas.AfComply.UI.admin.AdminPortal.EmployersCurrentNotPrintedPdf" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <h2>Current Unprinted PDFs for All Employers"</h2>
    <br />
    ...
    <asp:GridView ID="GridEmployerPdfCount" runat="server" AutoGenerateColumns="false"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="PDFs Not Printed Count" HeaderStyle-Width="25%" SortExpression="TransmissionStatusId" HeaderStyle-HorizontalAlign="Left">
                <ItemTemplate>
