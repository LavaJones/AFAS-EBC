<%@ Page EnableSessionState="ReadOnly" Language="C#" AutoEventWireup="true" CodeBehind="import_grosspay.aspx.cs" Inherits="import_grosspay_import" %>
        ...
        <div id="container">
            ...
            <div id="topbox">
                <div id="tbleft">
                    ...
                    <br />
                    <br />
                    <label class="lbl3">Select Gross Pay File</label>
                ...
                <div id="tbright">
                    ...
                    <span>
                        <ul>
                            <li>The Gross Pay File must be a "comma delimited" .csv file.</li>
