<%@ Page EnableSessionState="ReadOnly" Language="C#" AutoEventWireup="true" CodeBehind="import_insurance_discrepancy.aspx.cs" Inherits="import_insurance_discrepancy" %>
...
<html>
<head>
    <title>Insurance Discrepancy Files</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="container">
            ...
            <div id="topbox">
                <div id="tbleft">
                    <h4>Insurance Offer Discrepancy Files</h4>
                    ...
                    <br />
                    <br />
                    <label class="lbl3">Select Insurance Offer Discrepancy File</label>
                ...
                <div id="tbright">
                    ...
                    <asp:FileUpload ID="FuGrossPayFile" runat="server" Width="350px" Enabled="false"/>
                    <br />
                    <br />
                    <span>
                        <ul>
                            <li>The In must be a "comma delimited" .csv file.</li>
                            <li>File Specifications</li>
                        </ul>
                    </span>
                    <br />
                    <br />
                    <asp:Button ID="BtnUploadFile" runat="server" CssClass="btn" Text="Submit" OnClick="BtnUploadFile_Click" Enabled="false" />
