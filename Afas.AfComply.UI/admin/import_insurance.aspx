<%@ Page EnableSessionState="ReadOnly" Language="C#" AutoEventWireup="true" CodeBehind="import_insurance.aspx.cs" Inherits="import_ins_import" %>
        ...
        <div id="container">
            ...
            <div id="topbox">
                <div id="tbleft">
                    ...
                    <br />
                    <br />
                    <label class="lbl3">Select Insurance Offer File</label>
