<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="summer_hour_calculator.aspx.cs" Inherits="admin_summer_hour_calculator" %>
        ...
        <div id="container">
            ...
            <div id="topbox">
                <div id="tbleft">
                    ...
                    <br />
                    <label class="lbl3">Plan Year</label>
                    <asp:DropDownList ID="DdlPlanYear" runat="server" CssClass="ddl2" AutoPostBack="false"></asp:DropDownList>
                    <br />
                    <asp:Button ID="BtnCalculateSummerHours" runat="server" CssClass="btn" Text="Calculate Summer Hours" OnClick="BtnCalculateSummerHours_Click" />
                </div>
                <div id="tbright">
                </div>
            </div>
