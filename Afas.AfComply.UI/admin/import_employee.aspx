<%@ Page EnableSessionState="ReadOnly" Language="C#" AutoEventWireup="true" CodeBehind="import_employee.aspx.cs" Inherits="admin_employee_import" %>
        ...
        <div id="container">
            ...
            <div id="topbox">
                <div id="tbleft">
                    ...
                    <label class="lbl3">Initial Import</label>
                    <asp:CheckBox ID="CbInitialImport" runat="server" CssClass="cb" Height="20px" Width="20px" OnCheckedChanged="CbInitialImport_CheckedChanged" AutoPostBack="True" />
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    <asp:Panel ID="PnlInitial" runat="server" Visible="false">
                        <label class="lbl3">Select Employee Type</label>
                        <asp:DropDownList ID="DdlEmployeeType" runat="server" CssClass="ddl2"></asp:DropDownList>
                        <br />
                        <br />
                        <label class="lbl3">Select Plan Year</label>
                        <asp:DropDownList ID="DdlPlanYear" runat="server" CssClass="ddl2"></asp:DropDownList>
                        <br />
                        <br />
                        <label class="lbl3">Select Employee Class</label>
                        <asp:DropDownList ID="DdlEmployeeClass" runat="server" CssClass="ddl2"></asp:DropDownList>
                        <br />
                        <br />
                        <label class="lbl3">Select ACA Status</label>
                        <asp:DropDownList ID="DdlACAStatus" runat="server" CssClass="ddl2"></asp:DropDownList>
                        <br />
                        <br />
                    </asp:Panel>
                    <label class="lbl3">Select Demographic File</label>
                    <asp:DropDownList ID="DdlFileList" runat="server" CssClass="ddl2"></asp:DropDownList>
                    <br />
                    <br />
                    <asp:Button ID="BtnProcessFile" runat="server" Text="Import File Information" CssClass="btn" OnClick="BtnProcessFile_Click" />
                    <br />
                    <asp:Button ID="BtnRescanAlerts" runat="server" Text="Re-Scan Demographic Alerts" CssClass="btn" OnClick="BtnRescanAlerts_Click" />
                    <br />
                </div>
                <div id="tbright">
                    <h4>Upload File</h4>
