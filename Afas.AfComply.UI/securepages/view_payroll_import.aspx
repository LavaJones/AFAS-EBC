<%@ Page Title="" Language="C#" MasterPageFile="~/securepages/SecurePages.Master" AutoEventWireup="true" CodeBehind="view_payroll_import.aspx.cs" Inherits="securedpages_view_payroll_import" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="bodycontent" runat="server">
    ...
    <div style="display: inline; width: 50%;" id="content">

        <div style="width: 50%; margin-left: 26%; top: 15px; position: absolute;">
            <asp:UpdatePanel ID="upPayrollAlerts" runat="server">
                <ContentTemplate>
                    <h3 style="padding-left: 25%;">Payroll Alert - Mass Update / Export</h3>
                    <hr />
                    <asp:Panel ID="TempPanel" runat="server" DefaultButton="BtnApplyFilters">
                        <h3 style="padding-left: 35%;">Filter By</h3>
                        <table style="width: 100%;">
                            <tr style="font-weight: bold;">
                                <td style="width: 10%">
                                    <asp:CheckBox ID="Cb_f_BatchID" runat="server" Text="Batch ID" AutoPostBack="true" OnCheckedChanged="Cb_f_BatchID_CheckedChanged" />
                                    <br />
                                    <asp:TextBox ID="Txt_f_BatchID" runat="server" Text="n/a" Enabled="false"></asp:TextBox>
                                </td>
                                <td style="width: 10%">
                                ...
                                <td style="width: 10%">
                                    <asp:CheckBox ID="Cb_f_LastName" runat="server" Text="Last Name" AutoPostBack="true" OnCheckedChanged="Cb_f_LastName_CheckedChanged" /><br />
                            ...
                            <tr style="font-weight: bold;">
                                ...
                                <td style="width: 10%">
                                    ...
                                    <br />
                                    <asp:DropDownList ID="Ddl_f_PayDesc" runat="server" Enabled="false"></asp:DropDownList>
                                </td>
                                <td style="width: 10%">
                    ...
                    <asp:Panel ID="PnlUpdate" runat="server" DefaultButton="BtnSave">
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr style="font-weight: bold;">
                                <td style="width: 10%">
                                    <asp:CheckBox ID="Cb_u_PayDesc" runat="server" Text="Pay Description" AutoPostBack="true" OnCheckedChanged="Cb_u_PayDesc_CheckedChanged" />
                                    <br />
                                    <asp:DropDownList ID="Ddl_u_PayDesc" runat="server" Enabled="false"></asp:DropDownList>

                                </td>
                                <td style="width: 10%">
                                    <asp:CheckBox ID="Cb_u_CheckDate" runat="server" Text="Check Date" AutoPostBack="true" OnCheckedChanged="Cb_u_CheckDate_CheckedChanged" />
                                    <br />
                                    <asp:TextBox ID="Txt_u_Cdate" runat="server" Enabled="false" Text="n/a"></asp:TextBox>
                                    <br />
                                    Format: mm/dd/yyyy
        ...
        of
                    ...
                    <asp:GridView ID="GvPayrollData" runat="server" AutoGenerateColumns="False" OnPageIndexChanging="GvPayrollData_PageIndexChanging" OnSorting="GvPayrollData_Sorting" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" AllowSorting="True" PageSize="100">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="PAY_BATCH_ID" HeaderText="Batch" SortExpression="PAY_BATCH_ID" HeaderStyle-Width="50px" HeaderStyle-HorizontalAlign="Left">
                                <HeaderStyle Width="30px"></HeaderStyle>
                            </asp:BoundField>
                            <asp:BoundField DataField="EMPLOYEE_EXT_ID" HeaderText="Employee #" HeaderStyle-Width="75px" HeaderStyle-HorizontalAlign="Left" />
                            ...
                            <asp:BoundField DataField="PAY_GP_DESC" HeaderText="Pay Description" SortExpression="PAY_GP_DESC" HeaderStyle-Width="125px" HeaderStyle-HorizontalAlign="Left">
                    ...
                    <asp:Panel ID="PnlMessage" runat="server">
                        ...
                        <div style="position: relative; margin-left: auto; padding: 5px; margin-right: auto; border-radius: 10px; width: 600px; height: auto; margin-top: 0px; font-size: 12px; background-color: white; z-index: 10">
                            ...
                            <h3 style="color: #eb0029;">Webpage Message</h3>
