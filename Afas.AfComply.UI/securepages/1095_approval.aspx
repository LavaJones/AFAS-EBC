<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="1095_approval.aspx.cs" Inherits="approval_1095" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="container">
            ...
            <div id="content">
                <asp:ImageButton ID="ImgBtnExportCSV" runat="server" align="right" Height="30px" ImageUrl="~/images/csv.png" OnClick="ImgBtnExportCSV_Click" ToolTip="Export to .CSV file" />
                    ...
                    <ContentTemplate>
                        <div id="topbox">
                            ...
                            <div id="tbright">
                                <asp:Panel ID="PnlSearch" runat="server" DefaultButton="BtnFindEmployees">
                                    ...
                                    <asp:FileUpload ID="IRSFile" runat="server" Width="350px" />
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                        <td colspan="1">
                                                            ...
                                                            <asp:ImageButton ID="ImgBtnAll12" runat="server" ImageUrl="~/images/edit_all12.png" Width="20px" CommandName="All12" ToolTip="EDIT all 12" />
                        ...
                        <asp:Panel ID="PnlAll12" runat="server">
                            ...
                            <div style="position: relative; margin-left: auto; padding: 5px; margin-right: auto; border-radius: 10px; width: 600px; height: auto; margin-top: 0px; font-size: 12px; background-color: white; z-index: 10">
                                ...
                                <h3 style="color: black;">EditAll 12</h3>
                                <p>
                                    *Note: This will change all 12 months to values selected below. 
                                ...
                                <br />
                                <asp:Label ID="Lbl_all12_Line14" runat="server" CssClass="lbl4">Line 14:</asp:Label>
                                <asp:DropDownList ID="Ddl_all12_line14" runat="server" CssClass="ddl2"></asp:DropDownList>
                                <br />
                                <asp:Label ID="Label5" runat="server" CssClass="lbl4">Line 15:</asp:Label>
                                <asp:TextBox ID="Txt_all12_lcmp" runat="server" CssClass="txt3"></asp:TextBox>
                                <br />
                                <asp:Label ID="Label6" runat="server" CssClass="lbl4">Line 16:</asp:Label>
                                <asp:DropDownList ID="Ddl_all12_line16" runat="server" CssClass="ddl2"></asp:DropDownList>
                                <br />
                                <asp:Label ID="Label7" runat="server" CssClass="lbl4">Insurance Type:</asp:Label>
                                <asp:DropDownList ID="Ddl_all12_InsuranceType" runat="server" CssClass="ddl2"></asp:DropDownList>
                                <br />
                                <asp:Label ID="Label8" runat="server" CssClass="lbl4">Monthly Status:</asp:Label>
                                <asp:DropDownList ID="Ddl_all12_MonthlyStatus" runat="server" CssClass="ddl2"></asp:DropDownList>
                                <br />
                                <asp:Label ID="Label11" runat="server" CssClass="lbl4">Enrolled:</asp:Label>
                                <asp:CheckBox ID="Cb_all12_Enrolled" runat="server" />
                                <br />
                                <asp:Label ID="Label9" runat="server" CssClass="lbl4">MEC:</asp:Label>
                                <asp:CheckBox ID="Cb_all12_MEC" runat="server" />
                                <br />
                                <br />
